...
const BLOG = {
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'en-AU', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '即使失败一百次，也不要后悔一次。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dr Houzhi Wang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'My first personal site!', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://asphalt.wang', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Houzhi, 博客, Asphalt', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'houzhi_wang@seu.edu.cn', // 邮箱地址 例如mail@tangly1024.com
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/bitbug_favicon.ico', // blog favicon（favicon.ico） 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
